    ...
    recommendations: [
      {
        ...
        product: { id: 'DEP_ONLINE', name: en ? 'Online term deposit' : 'Tiền gửi có kỳ hạn trực tuyến', talkingPoints: [] },
        reasons: en
        ...
        script: en ? 'We noticed you have not used your account for a while. As a valued customer you qualify for our best deposit rate plus an online bonus — may we schedule a short meeting?' : 'Em thấy lâu rồi chị chưa giao dịch với MSB. Chị đang được hưởng mức lãi suất tiết kiệm cao nhất cộng thêm ưu đãi gửi online dành cho KHƯT, em xin hẹn chị 15 phút để tư vấn nhé?',
      },
    ],
    ...
    recommendations: [
      {
        ...
        product: { id: 'BANCA_PRU_PROTECT', name: 'Pru – Bảo vệ tối đa', talkingPoints: [] },
        ...
        script: en ? 'With a large mortgage in place, a protection plan keeps your family safe from the loan if anything happens. May I walk you through the options?' : 'Với khoản vay thế chấp hiện tại, một gói bảo vệ sẽ giúp gia đình anh không bị áp lực trả nợ nếu có rủi ro. Em xin phép trình bày phương án phù hợp nhé?',
      },
    ],
    guardrail: { sellAllowed: true, reason: null },
  }),
    ...
    recommendations: [
      {
        ...
        product: { id: 'CD_MSB', name: 'Chứng chỉ tiền gửi MSB', talkingPoints: [] },
        ...
        script: en ? 'Your current account balance has grown over this period. A certificate of deposit lets that money earn more while staying transferable.' : 'Số dư tài khoản của chị tăng trong kỳ này. Chứng chỉ tiền gửi MSB giúp khoản tiền đó sinh lời tốt hơn mà vẫn chuyển nhượng linh hoạt ạ.',
      },
    ],
    guardrail: { sellAllowed: true, reason: null },
  }),
    ...
    recommendations: [
      {
        ...
        product: { id: 'FX_SWIFT_PACKAGE', name: en ? 'FX & SWIFT transfer package' : 'Gói FX & chuyển tiền quốc tế SWIFT', talkingPoints: [] },
        ...
        script: en ? 'As one of our most valued investors, you can access preferential FX rates and SWIFT transfers — shall we review your international needs?' : 'Là một trong những khách hàng đầu tư giá trị nhất, chị được hưởng tỷ giá ưu đãi và kênh SWIFT — em cùng chị xem nhu cầu ngoại tệ sắp tới nhé?',
      },
    ],
    guardrail: { sellAllowed: true, reason: null },
  }),
