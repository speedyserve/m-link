export const messages = {
  vi: {
    ...
    behaviour: 'Hành vi', declared: 'khai báo', computed: 'tính toán',
    suggestion: 'Gợi ý kịch bản', productsHeld: 'Sản phẩm đang có', rbQueue: 'Hàng đợi RB theo Priority Score', branch: 'Chi nhánh', behaviourNote: 'Mô tả hành vi', noMaturity: 'Chưa có ngày đáo hạn', closed: 'Đã tất toán',
    ...
    statusCompleted: 'Hoàn tất', statusRunning: 'Đang chạy', statusPending: 'Đang chờ', statusFailed: 'Lỗi', statusTimeout: 'Hết thời gian', processingTime: 'Thời gian xử lý',
    navDashboard: 'M-Link Tổng quan', navCustomers: 'M-Link Danh sách khách hàng',
    txDate: 'Ngày', txDescription: 'Diễn giải', txAmount: 'Số tiền', txBalanceAfter: 'Số dư sau GD',
    typeDebit: 'Chi ra', typeCredit: 'Thu vào',
    cardLimit: 'Hạn mức', cardAvailable: 'Khả dụng', cardExpiry: 'Hết hạn',
    depositActive: 'Đang hiệu lực', interestRate: 'Lãi suất', openedOn: 'Mở ngày',
    sentimentPositive: 'Tích cực', sentimentNeutral: 'Trung tính', sentimentNegative: 'Tiêu cực',
    statusOpen: 'Đang mở', statusClosed: 'Đã xử lý',
    channelCall: 'Gọi điện', channelBranch: 'Tại quầy', channelApp: 'Ứng dụng', channelEmail: 'Email',
    typeComplaint: 'Khiếu nại', typeService: 'Chăm sóc', typeInquiry: 'Tư vấn',
  },
  en: {
    ...
    behaviour: 'Behaviour', declared: 'declared', computed: 'computed',
    suggestion: 'Suggested scenario', productsHeld: 'Products held', rbQueue: 'RB queue by Priority Score', branch: 'Branch', behaviourNote: 'Behaviour note', noMaturity: 'No maturity date', closed: 'Closed',
    ...
    statusCompleted: 'Completed', statusRunning: 'Running', statusPending: 'Pending', statusFailed: 'Failed', statusTimeout: 'Timed out', processingTime: 'Processing time',
    navDashboard: 'M-Link Overview', navCustomers: 'M-Link Customer list',
    txDate: 'Date', txDescription: 'Description', txAmount: 'Amount', txBalanceAfter: 'Balance after',
    typeDebit: 'Debit', typeCredit: 'Credit',
    cardLimit: 'Limit', cardAvailable: 'Available', cardExpiry: 'Expiry',
    depositActive: 'Active', interestRate: 'Interest rate', openedOn: 'Opened',
    sentimentPositive: 'Positive', sentimentNeutral: 'Neutral', sentimentNegative: 'Negative',
    statusOpen: 'Open', statusClosed: 'Resolved',
    channelCall: 'Phone call', channelBranch: 'Branch', channelApp: 'Mobile app', channelEmail: 'Email',
    typeComplaint: 'Complaint', typeService: 'Service', typeInquiry: 'Inquiry',
  },
} as const;
