...
export function BrandMark({ size = 36 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 36 36" role="img" aria-label="M-Link" className="shrink-0">
      <rect width="36" height="36" rx="12" fill="#091e42" />
  ...
  return (
    <span className="flex items-center gap-2.5">
      ...
      <span className="leading-tight">
        <span className="block text-xl font-black tracking-tight text-navy-900">M-Link</span>
        <span className="block text-[10px] font-bold uppercase tracking-[.14em] text-navy-500">MSB Retail Banking</span>
      </span>
    </span>
  );
}
