...
export function PeriodSummaryCard({ summary, locale, t }: { summary: PeriodSummary; locale: Locale; t: T }) {
  ...
  return <div className="card p-5">
    <div className="flex flex-wrap items-start justify-between gap-2"><h2 className="font-extrabold">{t('periodSummary')}</h2><span className="text-xs text-navy-500">{summary.range.from} → {summary.range.to} · {summary.range.days} {t('daysUnit')}</span></div>
